...
export function CartableSearchInput({
  ...
  return (
    <div className={`relative min-w-0 basis-full flex-1 sm:basis-auto sm:min-w-[200px] ${className}`}>
...
export function CartableSelectFilter({
  ...
  return (
    <select
      ...
      className={`w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 sm:w-auto ${className}`}
    >
